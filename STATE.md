...
<!-- STATE.md SIZE BUDGET: ~211 lines (wc-l) | target 200 lines (soft) | hard-cap 500 | margin from hard-cap: 289 | safe_to_compact: true | D-2521 FAST-FOLLOW STUBS -->
...
| **Started** | 2026-04-13 |
| **Last Updated** | 2026-09-15 D-2521: FAST-FOLLOW STUBS RECORDED (human-directed). 3 draft follow-up stories added (S-JSON-EXTRACT-TYPED-001, S-JSON-EXTRACT-NESTED-001, S-SPEC-OVERLAY-RELOCATION-001). story_index v3.036→v3.037; total_stories 341→344. STATE v10.026→v10.027. |
...
## Session Resume Checkpoint (D-2521 — FAST-FOLLOW STUBS RECORDED; STATE v10.027) [supersedes D-2520]
...
**BETA.3 REMEDIATION WAVE MAP (D-2520 inventory — full detail in Decisions Log D-2520):**
- W1: Tool-gating (issues 1,2) — gate 40 -32003 stubs; keep 14 live tools
- W2: Envelope (issues 3,5,7) — total_results, virtual fields, null/list encoding
- W2-arch: (issues 4,6) — example_query dedupe; total_available FULL FIX (BC-2.11.001 + ADR-060 + interface-definitions amend)
- W3: OCSF + JSON accessor (issues 8-13,20) — claroty.sensor.toml OCSF fixes; json_extract_string UDF; new BC+ADR+VP
- W4: Release (issues 14,15) — new BOHICA-LABS beta.3; install.sh drbothen→BOHICA-LABS URL fix
- W5: Docs (issues 16,17,18,19) — gh attestation verify runbook; SETUP.md §9 fix
...
**OPEN ITEMS:** (a) FIRST NEXT ACTION: F1 delta-analysis + story decomposition → human spec gate. (b) RECONCILIATION: develop +2 out-of-session (#284, #287). (c) PRs #292/#291/#288/#282 + Dependabot #266–#274. (d) PROCESS-GAP D-2503 (JUSTIFIED DEFERRAL D-2515). (e) RELEASE_PROMOTE_TOKEN PAT — BOHICA-LABS re-scope. (f) beta.2 log external only (D-2410). (g) fast-follow depends_on S-JSON-EXTRACT-UDF-001: reconcile at decomposition time.
