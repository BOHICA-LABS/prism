...
| HS-033 | [S-MCP-TOOL-GATE-001-HS-001-tools-list-count-14-without-operations-feature.md](S-MCP-TOOL-GATE-001-HS-001-tools-list-count-14-without-operations-feature.md), [S-MCP-TOOL-GATE-001-HS-002-list-capabilities-not-registered-tools-empty-wire-shape.md](S-MCP-TOOL-GATE-001-HS-002-list-capabilities-not-registered-tools-empty-wire-shape.md), [S-MCP-TOOL-GATE-001-HS-003-ops-tool-invocation-returns-32602-not-32003.md](S-MCP-TOOL-GATE-001-HS-003-ops-tool-invocation-returns-32602-not-32003.md) | operations Cargo Feature Gate — Tool Catalog and Error Code Semantics (P0) — S-MCP-TOOL-GATE-001 — HIDDEN, SINGLE-USE **[CONSUMED 2026-09-18 — D-2580: HS-MCP-GATE-001-001 PASS 1.00 (consumed; tools/list len==14, all 14 LIVE_TOOLS present, get_diagnostics and create_schedule absent; BC-2.10.017 §Postconditions absent-feature path), HS-MCP-GATE-001-002 PASS 1.00 (consumed; not_registered_tools==[] on wire in both client_id:null and unknown-client modes; field present empty array not null; EC-10-023; BC-2.10.011 §Postconditions), HS-MCP-GATE-001-003 PASS 1.00 (consumed; get_diagnostics→-32602 "tool not found"; create_schedule→-32602 "tool not found"; NOT -32003 NOT -32601; two-tool anti-special-case check; INV-OPERATIONS-FEATURE-GATE; BC-2.10.017 §Postconditions absent-feature path). Mean satisfaction 1.00. GATE PASS. Must NOT be reused.]** | 3 | P0 | HS-001: tools/list wire response has exactly 14 tools (all LIVE_TOOLS; zero stubs) when compiled without operations feature; BC-2.10.017 §Postconditions absent-feature path. HS-002: list_capabilities not_registered_tools is empty array [] on wire in both single-client and cross-client modes; BC-2.10.011 §Postconditions EC-10-023. HS-003: invoking a previously-stubbed tool returns JSON-RPC error -32602 "tool not found" NOT -32003; two-tool anti-special-case check; BC-2.10.017 §Postconditions absent-feature path INV-OPERATIONS-FEATURE-GATE. |
| HS-034 | [S-MCP-ENVELOPE-DESCRIBE-001-HS-001-prism-describe-total-results-wire-count.md](S-MCP-ENVELOPE-DESCRIBE-001-HS-001-prism-describe-total-results-wire-count.md), [S-MCP-ENVELOPE-DESCRIBE-001-HS-002-all-four-virtual-field-descriptors-in-columns.md](S-MCP-ENVELOPE-DESCRIBE-001-HS-002-all-four-virtual-field-descriptors-in-columns.md), [S-MCP-ENVELOPE-DESCRIBE-001-HS-003-virtual-field-column-descriptor-wire-shape.md](S-MCP-ENVELOPE-DESCRIBE-001-HS-003-virtual-field-column-descriptor-wire-shape.md) | prism_describe Total Results + Virtual Field Descriptors Fix (S-MCP-ENVELOPE-DESCRIBE-001) — HIDDEN, SINGLE-USE | 3 | P0 | Issue 3: total_results always 0 for prism_describe object shape (safety_envelope::wrap() tables-arm missing); Issue 5: _client, _source_table, _source_type absent from prism_describe column list (OQ-003 block incomplete) |
| HS-035 | [S-MCP-NULL-ENCODING-001-HS-001-string-null-wire-null-not-four-char-string-lockin.md](S-MCP-NULL-ENCODING-001-HS-001-string-null-wire-null-not-four-char-string-lockin.md), [S-MCP-NULL-ENCODING-001-HS-002-array-null-elements-filtered-from-raw-extensions.md](S-MCP-NULL-ENCODING-001-HS-002-array-null-elements-filtered-from-raw-extensions.md), [S-MCP-NULL-ENCODING-001-HS-003-is-null-predicate-and-null-not-absent-wire-shape.md](S-MCP-NULL-ENCODING-001-HS-003-is-null-predicate-and-null-not-absent-wire-shape.md) | Null/List-Null Encoding Fix (S-MCP-NULL-ENCODING-001) — HIDDEN, SINGLE-USE | 3 | P0 | Issue 7a lock-in: string-typed JSON null → "null" string in build_column_array (already fixed on develop per D-1110); Issue 7b: null elements in Value::Array arm serialized as "null" string elements in compact JSON-list stored under raw_extensions |
...
### HS-033: operations Cargo Feature Gate — Tool Catalog and Error Code Semantics (P0) — S-MCP-TOOL-GATE-001

Story-level holdout gate for S-MCP-TOOL-GATE-001 (beta.3 remediation — gate 40 operations stub tool handlers behind a default-OFF `operations` Cargo feature in prism-mcp; when feature absent: `NOT_YET_AVAILABLE_TOOLS = &[]`, no stubs registered, catalog shows only 14 LIVE_TOOLS, unregistered-tool invocations routed by rmcp to `-32602` InvalidParams "tool not found" NOT the prism-specific `-32003`; BC-2.10.017 §Postconditions absent-feature path + BC-2.10.011 `not_registered_tools` empty-slice wire shape). HIDDEN from test-writer and implementer. SINGLE-USE. Evaluates against prism binary compiled without `--features operations`. Requires MCP stdio session over JSON-RPC.

| ID | Title | Surfaces Tested | Result |
|----|-------|----------------|--------|
| HS-MCP-GATE-001-001 | tools/list wire response has exactly 14 tools: total count == 14 (not 54), all 14 LIVE_TOOLS present (query, explain_query, create_alias, list_aliases, delete_alias, explain_alias, confirm_action, reload_config, add_sensor_spec, list_sensor_specs, validate_config, list_capabilities, prism_describe, check_sensor_health), stub tools absent (get_diagnostics and create_schedule must NOT appear); asserts on serialized JSON tools array length and tool name set; BC-2.10.017 §Postconditions absent-feature path | prism-mcp (tool registration), prism-bin (boot.rs) | **PASS / CONSUMED** (sat 1.00; 2026-09-18; tools/list len==14 on wire; all 14 LIVE_TOOLS present; get_diagnostics and create_schedule absent; scenario used=true) |
| HS-MCP-GATE-001-002 | list_capabilities not_registered_tools wire shape: Part A client_id=null (cross-client mode) → not_registered_tools field PRESENT, value is `[]` (not null, not absent, not 40-element array); Part B client_id="holdout-test" (unknown-but-well-formed client) → same `[]` assertion; asserts on parsed result.content[0].text JSON; both parts must satisfy EC-10-023; BC-2.10.011 §Postconditions `not_registered_tools` | prism-mcp (list_capabilities handler), prism-bin | **PASS / CONSUMED** (sat 1.00; 2026-09-18; structuredContent.results.not_registered_tools==[] in both client_id:null and unknown-client modes; field present empty array not null/absent; scenario used=true) |
| HS-MCP-GATE-001-003 | ops tool invocation returns -32602 NOT -32003: Part A tools/call get_diagnostics → JSON-RPC error.code == -32602, error.message == "tool not found"; Part B tools/call create_schedule → same -32602/same-message (anti-special-case check); asserts on serialized JSON-RPC error envelope; discriminator: pre-patch returns -32003 from registered stub handler; correct returns -32602 from rmcp unregistered-tool router rejection; INV-OPERATIONS-FEATURE-GATE; BC-2.10.017 §Postconditions absent-feature path | prism-mcp (rmcp error_mapping.rs routing), prism-bin | **PASS / CONSUMED** (sat 1.00; 2026-09-18; get_diagnostics→{"code":-32602,"message":"tool not found"}; create_schedule→{"code":-32602,"message":"tool not found"}; NOT -32003 NOT -32601; scenario used=true) |

### HS-034: prism_describe Total Results + Virtual Field Descriptors Fix (P0) — S-MCP-ENVELOPE-DESCRIBE-001

Story-level holdout gate for S-MCP-ENVELOPE-DESCRIBE-001 (beta.3 remediation — Issue 3: `_meta.total_results` always 0 in `safety_envelope::wrap()` for the `{tables:[...]}` prism_describe object shape; Issue 5: synthesized ColumnDescriptors for _client, _source_table, _source_type absent from OQ-003 block; BCs: BC-2.10.012 v1.10, BC-2.11.012 v1.11; ADR-058 §G OQ-003). HIDDEN from test-writer and implementer. SINGLE-USE. Does NOT require Claroty DTU — prism_describe reads from loaded sensor TOML spec at boot. All assertions on SERIALIZED JSON from `result.content[0].text`. All 3 scenarios P0 must_pass.

| ID | Title | Crates Tested |
|----|-------|--------------|
| HS-DESC-001-001 | `_meta.total_results` in wire JSON equals `tables.length > 0`: Part A consistency check (total_results == tables.length); Part B non-zero assertion (catches `safety_envelope::wrap()` tables-arm missing — pre-patch hardcodes 0 regardless of table count); discriminating assertion via `WHERE total_results = 'null' LIMIT 1` returns 0 rows (BC-2.10.012 §Response envelope EC-10-032; BC-2.11.001 EC-11-079) | prism-mcp, prism-spec-engine, prism-bin |
| HS-DESC-001-002 | All four virtual field names present in `columns[*].name`: _sensor, _client, _source_table, _source_type; Part A virtual field presence (pre-patch only class_uid + _sensor present); Part B class_uid regression guard (must not be dropped by the extension); Part C no duplicate synthesized entries; asserts on parsed result.content[0].text wire JSON (BC-2.10.012 §Response shape OQ-003 amended; BC-2.11.012 §Invariants virtual field set exactly four) | prism-mcp, prism-spec-engine, prism-bin |
| HS-DESC-001-003 | Compound gate: virtual field column descriptors have `nullable: false` in wire JSON AND both Issue 3 + Issue 5 fixes self-consistent in one response; Part A `nullable == false` (JSON boolean false, not true/null/absent) on _client, _source_table, _source_type column descriptors (BC-2.11.012 §Invariants parity note: describe surface reflects populated-path nullable=false); Part B total_results == tables.length > 0 AND four virtual fields present; discriminates partial/incorrect implementations (BC-2.10.012 §Response shape EC-005; BC-2.11.012 §Invariants) | prism-mcp, prism-spec-engine, prism-bin |

### HS-035: Null/List-Null Encoding Fix (P0) — S-MCP-NULL-ENCODING-001

Story-level holdout gate for S-MCP-NULL-ENCODING-001 (beta.3 remediation — Issue 7a LOCK-IN: `Value::Null` in String column → Arrow null cell not literal "null" [already fixed on develop per D-1110; RG-NULL-001 is lock-in not Red Gate]; Issue 7b genuine fix: null elements inside `Value::Array` arm filtered out, all-null → "[]"; BCs: BC-2.16.003 v1.32, BC-2.11.001 v1.37). HIDDEN from test-writer and implementer. SINGLE-USE. Requires Claroty DTU (claroty_alerts for Issue 7a; claroty_devices for Issue 7b raw_extensions). All assertions on SERIALIZED JSON the LLM agent consumes. All 3 scenarios P0 must_pass.

| ID | Title | Crates Tested |
|----|-------|--------------|
| HS-NULL-001-001 | LOCK-IN regression guard for Issue 7a (string-typed JSON null → "null" string): Part A no row has `source_ip` value == "null" (JSON string "null") in claroty_alerts wire output; Part B PRIMARY DISCRIMINATING: `SELECT * FROM claroty_alerts WHERE source_ip = 'null' LIMIT 1` returns 0 rows (post-fix: null stored as Arrow null → predicate finds 0 rows; pre-fix regression: null stored as "null" string → predicate matches); asserts on row count in result.content[0].text JSON; Part C null-not-absent: rows with null source_ip emit `"source_ip": null` (key present) NOT absent key (BC-2.16.003 §Postconditions EC-016-013-006 amended; BC-2.11.001 EC-11-079 null-not-absent) | prism-mcp, prism-spec-engine, prism-dtu-claroty, prism-bin |
| HS-NULL-001-002 | Issue 7b: null elements filtered from compact JSON-list in raw_extensions; `SELECT raw_extensions FROM claroty_devices LIMIT 10`; Part A no string element == "null" inside any compact JSON-list stored under raw_extensions (pre-fix: null elements serialized as "null" string — EC-016-013-041 violated); Part B non-null elements preserved (EC-016-013-026: array column type non-regression); Part C structural validity: every raw_extensions value is either SQL NULL or a valid JSON string; SETUP-FAILURE if DTU has no device rows or no array columns (partial credit 0.5 applied, not zero) (BC-2.16.003 §Postconditions EC-016-013-041 new; EC-016-013-026) | prism-mcp, prism-spec-engine, prism-dtu-claroty, prism-bin |
| HS-NULL-001-003 | End-to-end behavioral chain: IS NULL predicate + null-not-absent wire shape; Part A `WHERE source_ip IS NULL` returns N_null > 0 rows (tests Arrow null cells are queryable via IS NULL; pre-fix null stored as "null" string → IS NULL finds 0 rows); Part B null cells appear as `"source_ip": null` (key present, value null JSON) NOT absent key (BC-2.11.001 EC-11-079 null-not-absent; `WriterBuilder::with_explicit_nulls(true)` must be active); Part C partition coverage: N_null + N_not_null == N_total (all three via count queries + projection query; pre-fix violates partition correctness when null data stored as "null" string); three count queries + one projection query pattern (BC-2.11.001 EC-11-079; BC-2.16.003 §Postconditions EC-016-013-006 amended) | prism-mcp, prism-spec-engine, prism-dtu-claroty, prism-bin |

### HS-036: prism_describe Synthesized Column Aggregate Exclusion (P0) — S-DESCRIBE-EXAMPLE-DEDUP-001

**Story:** S-DESCRIBE-EXAMPLE-DEDUP-001 — Exclude synthesized OCSF virtual columns from auto-generated aggregate example query target
**BC:** BC-2.10.012 v1.11 (EC-10-033 synthesized-column exclusion from Tier-2 agg_col)
**DTU required:** No (prism_describe reads TOML spec at boot; no live DTU queries)
**P0 must_pass:** All 3

| Scenario ID | Short Description | Crates Touched |
|------------|-------------------|----------------|
| HS-DESC-DEDUP-001-001 | No `GROUP BY class_uid` in any tables[*].example_query across all sensors; Claroty as discriminating surface (all tables had Integer class_uid pre-patch, post-fix none do); assertions on serialized prism_describe JSON response | prism-mcp, prism-spec-engine, prism-bin |
| HS-DESC-DEDUP-001-002 | At least one tables[*].example_query contains `NOW()` (Tier-3 count-recent fallthrough); Claroty has Datetime columns → tier3_count >= 1 post-fix (pre-fix = 0 because all tables had GROUP BY class_uid); asserts COUNT(*) + NOW() - INTERVAL + WHERE + no GROUP BY structural properties on Tier-3 examples | prism-mcp, prism-spec-engine, prism-bin |
| HS-DESC-DEDUP-001-003 | Universal 5-name prohibition (class_uid + _sensor + _client + _source_table + _source_type) across all sensors; Tier-1 non-regression (tables with severity_score column must use WHERE not GROUP BY); cross-sensor coverage | prism-mcp, prism-spec-engine, prism-bin |

### HS-037: True Upstream Sensor Total in Query Response (P0) — S-QUERY-TRUE-TOTAL-001

**Story:** S-QUERY-TRUE-TOTAL-001 — Thread upstream sensor total_count through pagination pipeline to total_available
**BC:** BC-2.11.001 v1.37 (EC-11-095 MUST-1..11); ADR-060 §D8.11 (gated formula)
**DTU required:** Yes — Claroty DTU (claroty_devices + claroty_alerts; total_count_path="total")
**P0 must_pass:** All 3

| Scenario ID | Short Description | Crates Touched |
|------------|-------------------|----------------|
| HS-QTT-001-001 | `FROM claroty_devices LIMIT 25`: total_available > 25, returned_results == 25, is_truncated == true; upstream Claroty JSON {"total": N, ...} with N >> 25; discriminating: pre-patch total_available=25, post-fix total_available=N; assertions on serialized query_context JSON | prism-mcp, prism-spec-engine, prism-dtu-claroty, prism-bin |
...
hs033_s_mcp_tool_gate_001: true
hs033_authored: true
hs033_gate_status: consumed
hs033_consumed: true
hs033_consumed_ref: D-2580
hs033_mean_satisfaction: 1.00
hs033_all_3_pass_sat: 1.00
hs034_s_mcp_envelope_describe_001: true
hs034_authored: true
hs034_gate_status: pending
hs035_s_mcp_null_encoding_001: true
hs035_authored: true
hs035_gate_status: pending
hs036_s_describe_example_dedup_001: true
hs036_authored: true
hs036_gate_status: pending
hs036_dtu_required: false
hs037_s_query_true_total_001: true
hs037_authored: true
...
|---------|-------|------|--------|--------|
| 1.47 | s-mcp-tool-gate-001-holdout-consumed | 2026-09-18 | state-manager | D-2580: HS-033 all 3 scenarios CONSUMED — S-MCP-TOOL-GATE-001 story-level holdout gate PASS (3/3 P0 must-pass; all satisfaction 1.00; BC-5.39.001 LOCAL 3-CLEAN CONVERGED on frozen HEAD 6a0986ace; real MCP stdio; wire-level assertions). HS-MCP-GATE-001-001 PASS 1.00 (consumed; tools/list len==14 on wire; all 14 LIVE_TOOLS present; get_diagnostics and create_schedule absent; BC-2.10.017 §Postconditions absent-feature path). HS-MCP-GATE-001-002 PASS 1.00 (consumed; not_registered_tools==[] on wire in both client_id:null and unknown-client modes; field present empty array not null/absent; EC-10-023; BC-2.10.011 §Postconditions). HS-MCP-GATE-001-003 PASS 1.00 (consumed; get_diagnostics→-32602 "tool not found"; create_schedule→-32602 "tool not found"; NOT -32003 NOT -32601; two-tool anti-special-case check; INV-OPERATIONS-FEATURE-GATE; BC-2.10.017 §Postconditions absent-feature path). Mean satisfaction 1.00 all 3 P0. GATE PASS. Scenario files: used→true / lifecycle_status→consumed / input-hash populated / last_evaluated 2026-09-18 / last_eval_satisfaction 1.00. State Checkpoint: hs033_consumed: true / hs033_consumed_ref: D-2580 / hs033_gate_status: consumed. total_scenarios/total_groups/p0_scenarios UNCHANGED at 148/34/126. |
